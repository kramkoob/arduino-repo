...
#ifndef TELLO_PACKET_PARAMETERS
#define TELLO_PACKET_PARAMETERS

#define START_OF_PACKET                     uint8_t(0xcc)
...
#define TAKEOFF_CMD                         uint8_t(0x0054)
...
#ifndef CRCTABLE
#define CRCTABLE
const PROGMEM uint8_t crc8table[] = {
...
const PROGMEM uint16_t crc16table[] = {
